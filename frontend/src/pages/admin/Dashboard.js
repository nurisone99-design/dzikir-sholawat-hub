    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">
          Ringkasan data Majelis Raudhatul Jannah hari ini.
        </p>
      </div>
        ...
        <div className="premium-card p-6">
          ...
          <div className="flex justify-center gap-6 mt-2 text-sm">
            <span className="flex items-center gap-2">
              <span className="h-3 w-3 rounded-full bg-[#0F766E]" /> Laki-laki
            </span>
            <span className="flex items-center gap-2">
              <span className="h-3 w-3 rounded-full bg-[#C5A059]" /> Perempuan
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="premium-card p-6">
        ...
        <div className="space-y-3">
          {data?.upcoming_agenda?.length ? (
            data.upcoming_agenda.map((a) => (
              <div
                key={a.id}
              ...
              >
                ...
                <div className="min-w-0">
                  ...
                  <p className="text-sm text-muted-foreground flex items-center gap-1">
                    <MapPin className="h-3.5 w-3.5" /> {a.lokasi} • {a.waktu}
                  </p>
                </div>
              </div>
            ))
