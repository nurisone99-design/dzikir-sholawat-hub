...
export default function Galeri() {
  ...
  const filtered =
    cat === "Semua" ? items : items.filter((i) => i.kategori === cat);
      ...
      <section className="islamic-pattern relative">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-24 text-center">
          ...
          <p className="mt-5 text-white/75 leading-relaxed">
            Momen dzikir, sholawat, dan kebersamaan jamaah dalam berbagai
            kegiatan majelis.
          </p>
        </div>
      </section>
              ...
              >
                <div className="relative h-full">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-emerald-950/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-4">
                    <div>
                      <Badge className="bg-gold text-emerald-900 hover:bg-gold text-[10px] mb-1">
                        {item.kategori}
                      </Badge>
          ...
          >
            ...
            >
              ...
              <div className="text-center mt-4">
                <Badge className="bg-gold text-emerald-900 hover:bg-gold mb-2">
                  {lightbox.kategori}
                </Badge>
